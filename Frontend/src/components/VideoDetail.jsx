...
function VideoDetail() {
  ...
  useEffect(() => {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        // Initialize Like, Dislike & Sub data from backend
  ...
  // 🚀 Handle Like Toggle (Updated with Mutual Exclusion)
  const handleLikeToggle = async () => {
    ...
    try {
      ...
      setLikesCount((prev) =>
        previousIsLiked ? prev : isLiked ? prev - 1 : prev + 1,
      );
      console.error("Like toggle failed", error);
    }
  };

  // 🚀 NEW: Handle Dislike Toggle (Mutual Exclusion)
  const handleDislikeToggle = async () => {
    ...
    try {
      // Note: Endpoint depends on your backend implementation for dislikes
  ...
  if (loading)
    return (
      <div className="text-center py-20 text-white italic">
        Loading Video...
      </div>
    );
            ...
            <div className="flex items-center gap-3">
              ...
              {currentUser?._id !== video.owner?._id && (
                <button
                  ...
                  className={`ml-2 px-4 py-2 rounded-full font-bold text-sm transition-all ${
                    isSubscribed
            ...
            <div className="flex items-center">
              <div className="flex items-center bg-white/10 rounded-full overflow-hidden border border-white/5">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 hover:bg-white/10 transition active:scale-90"
                >
                  <svg
                ...
                <button 
                  ...
                  className="px-4 py-2 hover:bg-white/10 transition active:scale-90"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
